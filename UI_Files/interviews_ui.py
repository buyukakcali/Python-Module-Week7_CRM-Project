...
"}")
        ...
        self.pushButtonAssignedApllicants = QtWidgets.QPushButton(parent=FormInterviews)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButtonAssignedApllicants.sizePolicy().hasHeightForWidth())
        self.pushButtonAssignedApllicants.setSizePolicy(sizePolicy)
        self.pushButtonAssignedApllicants.setMinimumSize(QtCore.QSize(150, 35))
        self.pushButtonAssignedApllicants.setMaximumSize(QtCore.QSize(200, 16777215))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setBold(True)
        self.pushButtonAssignedApllicants.setFont(font)
        self.pushButtonAssignedApllicants.setStyleSheet("QPushButton{\n"
"    border-radius : 15px;\n"
"    background-color : rgb(25, 200, 200);\n"
"    color: rgb(255, 255, 255);\n"
"}\n"
...
" border: 2px solid rgb(162, 0, 0);\n"
"}")
        self.pushButtonAssignedApllicants.setObjectName("pushButtonAssignedApllicants")
        self.gridLayout.addWidget(self.pushButtonAssignedApllicants, 5, 0, 1, 1)
...
"color: rgb(71, 84, 88);")
        ...
        self.pushButtonAssignedApllicants.raise_()
    ...
    def retranslateUi(self, FormInterviews):
        ...
        self.pushButtonAssignedApllicants.setText(_translate("FormInterviews", "Assigned Aplicants"))
