...
class Ui_FormUserMenu(object):
    def setupUi(self, FormUserMenu):
        ...
        self.labelLogo2 = QtWidgets.QLabel(parent=FormUserMenu)
        self.labelLogo2.setGeometry(QtCore.QRect(160, 30, 261, 61))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        font.setBold(True)
        self.labelLogo2.setFont(font)
        self.labelLogo2.setStyleSheet("QLabel {\n"
...
"}")
        ...
        self.labelPicMenu.setStyleSheet("QLabel {\n"
"    background-color: rgba(0, 0, 0,0%);\n"
"}")
        self.labelPicMenu.setText("")
        self.labelPicMenu.setPixmap(QtGui.QPixmap("UI_Files\\pictures/pic_user_loop.png"))
...
"")
        ...
        self.labelUsers.setPixmap(QtGui.QPixmap("UI_Files\\pictures/icon_user.png"))
        ...
        self.frameCurrentUser.setGeometry(QtCore.QRect(430, 10, 71, 51))
        ...
        self.labelCurrentUserPic.setPixmap(QtGui.QPixmap("UI_Files\\pictures/logo_organization1.ico"))
        self.labelCurrentUserPic.setScaledContents(True)
...
"")
        ...
        self.labelLogo1 = QtWidgets.QLabel(parent=FormUserMenu)
        self.labelLogo1.setGeometry(QtCore.QRect(80, 20, 80, 80))
        self.labelLogo1.setStyleSheet("QLabel {\n"
"    background-color: rgba(0, 0, 0,0%);\n"
"}")
