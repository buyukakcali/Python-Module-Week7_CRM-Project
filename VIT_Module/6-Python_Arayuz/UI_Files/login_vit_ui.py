...
"")
        ...
        self.labelLogo.setGeometry(QtCore.QRect(105, 35, 185, 40))
...
"")
        ...
        self.labelLogo_2 = QtWidgets.QLabel(parent=self.centralwidget)
        self.labelLogo_2.setGeometry(QtCore.QRect(40, 20, 65, 70))
        self.labelLogo_2.setStyleSheet("background-color: rgba(0, 0, 0,0%);")
        self.labelLogo_2.setText("")
        self.labelLogo_2.setPixmap(QtGui.QPixmap("UI_Files\\pictures/werhere_logo.ico"))
