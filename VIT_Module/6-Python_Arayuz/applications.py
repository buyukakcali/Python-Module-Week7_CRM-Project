...
class ApplicationsPage(QWidget):
    ...
    def app_last_period_applications(self):
        try:
            ...
            raise Exception(f"Error occurred in app_last_period_applications method: {e}")
    ...
    def app_all_applications(self):
        try:
            ...
            raise Exception(f"Error occurred in app_all_applications method: {e}")
    ...
    def search_application(self):
        try:
            ...
            if self.applications:
                self.filtering_list = list(self.applications)  # Filtreleme için listeyi ata.
    ...
    def filter_table(self):
        try:
            ...
            myf.filter_table_f(self.form_applications, self.headers, self.filtering_list, self.filtering_column)
        except Exception as e:
