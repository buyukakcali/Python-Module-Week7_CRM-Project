# Form implmentation generated from reading ui file 'applications_ui.ui'
#
...
"}")
        ...
        self.pushButton_app_pre_vit_control.setGeometry(QtCore.QRect(40, 410, 171, 31))
        font = QtGui.QFont()
        font.setBold(True)
...
"}")
        ...
        self.pushButton_app_rep_registrations.setGeometry(QtCore.QRect(40, 360, 171, 31))
        font = QtGui.QFont()
        font.setBold(True)
...
"Situation"))
        ...
        item.setText(_translate("Form", "Language Course"))
        item = self.tableWidget.horizontalHeaderItem(8)
        item.setText(_translate("Form", "English Level"))
        item = self.tableWidget.horizontalHeaderItem(9)
        item.setText(_translate("Form", "NL level"))
        item = self.tableWidget.horizontalHeaderItem(10)
        item.setText(_translate("Form", "Municipality Press"))
        item = self.tableWidget.horizontalHeaderItem(11)
        item.setText(_translate("Form", "Other Bootcamp"))
        item = self.tableWidget.horizontalHeaderItem(12)
        item.setText(_translate("Form", "IT from Internet"))
        item = self.tableWidget.horizontalHeaderItem(13)
        item.setText(_translate("Form", "Projects Involved"))
        item = self.tableWidget.horizontalHeaderItem(14)
        item.setText(_translate("Form", "Which Part IT"))
        item = self.tableWidget.horizontalHeaderItem(15)
        item.setText(_translate("Form", "Why IT"))
        item = self.tableWidget.horizontalHeaderItem(16)
        item.setText(_translate("Form", "Motivation"))
        item = self.tableWidget.horizontalHeaderItem(17)
        item.setText(_translate("Form", "Mentor Interview"))
